...
vector<string> separareAtomi() {
    ...
    vector<string> erori_lexicale;
    erori_lexicale.push_back("Erori lexicale:\n");
    ...
    for (string word : text) {
        if (word.compare("#include<iostream>") == 0 || word.compare("using") == 0 || word.compare("namespace") == 0 || word.compare("std") == 0 || word.compare("int") == 0
            || word.compare("float") == 0 || word.compare("main") == 0 || word.compare("cout<<") == 0 || word.compare("cin>>") == 0)
            cuv_cheie.push_back(word);
        else
            if (word.compare("*") == 0 || word.compare("=") == 0 || word.compare("+") == 0 || word.compare("-") == 0)
                operatori.push_back(word);
            else
                if (word.compare(",") == 0 || word.compare(";") == 0 || word.compare("{") == 0 || word.compare("}") == 0 || word.compare("(") == 0 || word.compare(")") == 0)
                    ...
                    if (FIP::checkCONST(word))
                        ...
                        else erori_lexicale.push_back(word);
    }
    ...
    cuv_cheie.insert(cuv_cheie.end(), erori_lexicale.begin(), erori_lexicale.end());
