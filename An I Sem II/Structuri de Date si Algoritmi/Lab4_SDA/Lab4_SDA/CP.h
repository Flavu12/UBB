...
private:
	int capacitate;
	int prim;//elementul cu cea mai mare prioritate(prim)
	int ultim;//elementul cu cea mai mica prioritate(ultim)
	int primLiber;//primLiber-primul spatiu ramas liber
	Element* elemente;
	int* urm;
	Relatie r;
...
public:
	...
	TPrioritate modificaPrioritate(TElem elem, TPrioritate nouaPrioritate);
